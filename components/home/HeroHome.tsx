        ...
        >
            ...
            >
                <Image
                    ...
                    fill
                    priority
                    className="object-contain drop-shadow-[0_50px_70px_rgba(43,34,24,0.45)] scale-110 md:scale-125 origin-center"
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 w-full relative z-10 grid md:grid-cols-[55%_45%] gap-10 items-center py-20 pb-32">
                ...
                <div className="flex flex-col items-start gap-8 relative z-20">
                    ...
                    <h1 className="font-serif text-[52px] md:text-[84px] lg:text-[100px] leading-[0.97] tracking-[-0.02em] text-white">
                        <StaggeredText text="'Understanding our Energetic Architecture' is now available on" />
                        <motion.span
                            initial={{ opacity: 0, y: 40 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.8, delay: 1.2 }}
                            className="inline-flex mt-2 md:mt-4 ml-2"
                        >
                            {/* Official Amazon Logo SVG */}
                            <svg viewBox="0 0 102 31" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="w-[140px] md:w-[220px] lg:w-[260px] text-white my-auto align-baseline pb-1">
                    ...
                    >
                        <Button
                            href="/book"
                            variant="primary"
                            className="bg-[#2B2218] text-[#F0EBE3]" // Overriding primary bg to dark charcoal for contrast on terracotta
                        >
                            Shop the book
                        </Button>
                    </motion.div>
