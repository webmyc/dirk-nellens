          ...
          `,
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 w-full relative z-10 grid md:grid-cols-[55%_45%] gap-10 items-center py-20 pb-32">
                ...
                <div className="flex flex-col items-start gap-8 relative z-20">
                    ...
                    <h1 className="font-serif text-[52px] md:text-[88px] lg:text-[110px] leading-[0.97] tracking-[-0.02em] text-white">
                        <StaggeredText text="'Understanding our Energetic Architecture' is now available on Amazon" />
                    </h1>
