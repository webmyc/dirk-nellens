                ...
                {sessionCards.map((card, i) => (
                    <FadeUp delay={0.15 + i * 0.1} key={card.title} className="h-full">
                        ...
                        >
                            ...
                            <div className="absolute top-0 left-0 h-[3px] bg-[#D27349] w-0 transition-all duration-400 ease-out group-hover:w-full" />
                            ...
                            <div className="flex flex-col h-full justify-between gap-8 pt-2">
                                <div>
                                    ...
                                    <div className="font-sans font-medium text-[18px] text-[#D27349] mb-6">
                                        {card.price}
                                    </div>
                                ...
                                <div className="flex items-center justify-between text-[#2B2218] mt-4">
                                    <span className="font-sans text-[14px] font-medium opacity-60 group-hover:opacity-100 group-hover:text-[#D27349] transition-colors">
                                        Find out more
                                    </span>
                                    <div className="w-8 h-8 rounded-full border border-[#2B2218]/20 flex items-center justify-center group-hover:bg-[#D27349] group-hover:border-[#D27349] group-hover:text-[#F0EBE3] transition-colors bg-white/50">
