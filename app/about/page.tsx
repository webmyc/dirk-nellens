    ...
    <main className="min-h-screen flex flex-col bg-[#F7F4EF]">
      ...
      <section className="relative min-h-[70vh] flex flex-col justify-center overflow-hidden pt-32 pb-24 bg-[#2B2218]">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-12 text-center text-[#F0EBE3] flex flex-col items-center">
          <FadeUp delay={0.1}>
            <p className="font-sans text-[12px] md:text-[14px] font-semibold tracking-[0.2em] uppercase text-[#D27349] mb-8">
              Dirk Nellens
            </p>
          </FadeUp>
          <FadeUp delay={0.2}>
            <blockquote className="font-serif text-[42px] md:text-[64px] lg:text-[80px] leading-[1.05] tracking-[-0.01em]">
              Evolution is clearly inviting us <span className="italic text-[#D27349]">to go inwards.</span>
            </blockquote>
          </FadeUp>
        </div>
      </section>
      ...
      <section id="contact" className="py-32 bg-[#2B2218] text-[#F0EBE3] relative overflow-hidden">
        {/* Subtle glow effect */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#D27349] rounded-full blur-[150px] opacity-10 pointer-events-none" />

        <div className="max-w-4xl mx-auto px-6 md:px-12 text-center flex flex-col items-center gap-8 relative z-10">
          <FadeUp delay={0.1}>
            <p className="font-sans text-[13px] uppercase tracking-[0.2em] text-[#D27349] font-semibold">
              Contact
            </p>
          </FadeUp>
          <FadeUp delay={0.2}>
            <p className="font-serif text-[28px] md:text-[36px] leading-[1.4] opacity-90 max-w-2xl">
              For all inquiries, including Dirk&rsquo;s availability for a Corporate Event or Live Speaking, please email
            </p>
          </FadeUp>
          <FadeUp delay={0.3}>
            <a
              href="mailto:dirknellens@nellens.com"
              className="font-sans font-medium text-[24px] md:text-[32px] md:font-semibold tracking-tight hover:text-[#D27349] transition-colors relative group underline underline-offset-8 decoration-[#F0EBE3]/20 hover:decoration-[#D27349]"
            >
      ...
      <section className="py-24 md:py-32 bg-[#EBE4D8] border-b border-[#2B2218]/5">
        <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
          ...
          <FadeUp delay={0.3}>
            <p className="mt-12 font-sans text-[14px] font-semibold tracking-[0.2em] uppercase text-[#D27349]">
              — Dirk Nellens
            </p>
          </FadeUp>
        </div>
